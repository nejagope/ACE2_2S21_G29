...
SoftwareSerial arduino2(6, 7); // (Rx,Tx) ---------------------------------pin ditital 11 y 10
...
int leerPasos()
{
  ...
  {
    Serial.print("\nArduino2\n");
    String lectura = arduino2.readString();
  ...
  while (1)
  {
    ...
    for (byte i = 75; i < 100; i++)
    {
      ...
      if (validHeartRate && validSPO2)
      {
        ...
        int pasos = leerPasos();
        String salida = String(((millivolts/10)- 32) * (5.0/9.0)) + "," + String(spo2) + "," + String(heartRate) + "," + String(pasos) + "#";
        Serial.print(salida);
        wifi.println(salida);
      }
    }
