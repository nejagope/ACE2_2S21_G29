    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener {
            ...
            val stringRequest = object: StringRequest(Request.Method.POST, url, Response.Listener { response ->
                ...
                if (resultado != 0){
                    Toast.makeText(this, "Datos incorrectos, por favor pruebe de nuevo", Toast.LENGTH_LONG).show()
                }else{
                    ...
                    val nombre = (JSONObject(informacion.toString()).get("nombre")).toString()
                    val apellido = (JSONObject(informacion.toString()).get("apellido")).toString()

                    GlobalValues.codigo = codigo
                    GlobalValues.nombre = nombre
                    GlobalValues.apellido = apellido
